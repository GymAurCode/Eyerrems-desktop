  ...
  return {
    ...
    server: {
      ...
      proxy: {
        ...
        "/ai": proxyConfig(proxyTarget),
        "/uploads": proxyConfig(proxyTarget),
        "/api": proxyConfig(proxyTarget),
        "/bootstrap": proxyConfig(proxyTarget),
        "/health": proxyConfig(proxyTarget),
        "/lookups": proxyConfig(proxyTarget),
        "/attachments": proxyConfig(proxyTarget),
