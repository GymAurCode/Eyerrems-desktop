...
export default function DataTableExamples() {
  return (
    <div className="p-6 space-y-8">
      <div>
        <h1 className="text-2xl font-bold text-primary mb-2">DataTable Examples</h1>
      ...
      <section>
        <h2 className="text-xl font-semibold text-primary mb-4">HR Module - Employee Management</h2>
        <EmployeeTable />
      </section>

      <section>
        <h2 className="text-xl font-semibold text-primary mb-4">Finance Module - Chart of Accounts</h2>
